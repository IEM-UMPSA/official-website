    ...
    <section className="course__area pt-115 pb-120 grey-bg-2">
        <Tabs variant="enclosed" id="react-tabs-276">
            <div className="container">
                     ...
                     <div className="course__menu d-flex justify-content-lg-end mb-20">
                        <div className="masonary-menu filter-button-group">
                           <TabList>
                                ...
                                <Tab><button>Engineering Technology</button></Tab>
                            </TabList>
                       </div>
                     </div>
                  </div>
               ...
               <TabPanel>
               <div className="row">
               { committee2122Data.slice(8, 10).map(item => (
               ...
               <TabPanel>
               <div className="row">
               { committee2122Data.slice(10, 13).map(item => (
               <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                  <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                     <div className="teacher__thumb w-img fix">
                        <img className="object-fill w-32 h-64" src={item.img} alt="img not found" />
               ...
               <TabPanel>
               <div className="row">
                  { committee2122Data.slice(13, 17).map(item => (
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <img className="object-fill w-32 h-64" src={item.img} alt="img not found" />
               ...
               <TabPanel>
               <div className="row">
               { committee2122Data.slice(17, 22).map(item => (
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <img className="object-fill w-32 h-64" src={item.img} alt="img not found" />
               ...
               <TabPanel>
               <div className="row">
                  { committee2122Data.slice(22, 25).map(item => (
                     <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                        <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                           <div className="teacher__thumb w-img fix">
                              <img className="object-fill w-32 h-64" src={item.img} alt="img not found" />
