                     ...
                     <div className="col-xxl-6 offset-xxl-3">
                        <div className="section__title-wrapper text-center mb-10">
                           <h2 className="section__title">
                              <span className="yellow-bg"> Management <img src="/assets/img/shape/yellow-bg-2.png" alt="img not found" /></span> Team
                           </h2>
                        </div>
                     </div>
                  </div>
                  <div className="row">
                  { committee2223Data.slice(0, 8).map(item => (
                     <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                        <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                           <div className="teacher__thumb w-img fix">
                             <img className="object-fill w-32 h-60" src={item.img} alt="img not found" />
                           </div>
