...
const events = [
  ...
  },
  {
    ...
    uploadLink: 'https://umpedumy-my.sharepoint.com/:f:/g/personal/tb20091_student_umpsa_edu_my/EnaBS0NSdvdGt3kD9pijhkQBfItPyGHWy92uB9z01RQ1vQ?e=bcyEur',
  },
  {
    ...
    uploadLink: 'https://umpedumy-my.sharepoint.com/:f:/g/personal/tb20091_student_umpsa_edu_my/EqzSfQATdLVFu-AviH2FRSsBIJze59rjHkOnaJV8dmLyJg?e=2fnXqh',
  },
  {
  ...
  },
  {
    ...
    uploadLink: 'https://umpedumy-my.sharepoint.com/:f:/g/personal/tb20091_student_umpsa_edu_my/EmydO5Wo-X9Mp_68XxntRVcBjHBvnGjJ0_q73vS1VFeGOg?e=dsm9Hb',
  },
];
...
const EngineeringPage: React.FC = () => {
  return (
    <>
      <Header />
      <div className="flex flex-col gap-8 items-center mt-8 px-4 md:px-0">
        <div className="relative w-full max-w-4xl">
          <div className="flex flex-col md:flex-row items-center md:items-start md:gap-4">
            <div className="md:w-1/2 text-center md:text-left">
              <h1 className="text-4xl font-bold">Engineering Week 2024</h1>
            ...
            <div className="md:w-1/2 mt-4 md:mt-24 flex justify-center">
              <img
                src="/ew.jpg"
                ...
                <div className="space-y-2 text-center md:text-left">
                  ...
                  <div className="flex justify-center md:justify-start items-center gap-2">
                    <Button size="sm" variant="outline" className="bg-blue-200">
                      ...
                      <Link href={event.uploadLink} target="_blank" className="ml-2">
                        View Photo
                      </Link>
                    </Button>
                  </div>
